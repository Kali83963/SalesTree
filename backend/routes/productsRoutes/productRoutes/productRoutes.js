...
router.get('/list-all',validateToken,permissionMiddleware,productController.ListController);
router.get('/list-all/search',validateToken,permissionMiddleware,productController.ListController);
router.patch('/check-product-quantity/:id',validateToken,permissionMiddleware,productController.QuantityCheckController);
